...
class UploadsController extends UploadsAppController {
	...
	public function admin_upload() {
		$data = $this->request->data['eventData']->data;
		if ($this->_isUploadedFile($data['source'])) {
			return $this->_moveUploadedFile($data['source'], $data['dest']);
		}
		return false;
	}
	...
	protected function _moveUploadedFile($file, $dest) {
