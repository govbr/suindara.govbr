...
-- INSERT INTO `categorias` (`id`, `titulo`, `descricao`, `parent_id`, `site_id`, `lft`, `rght`) VALUES(5, 'Acessibilidade Projetos', 'Projetos de Acessibilidade', NULL, 1, 9, 10);
...
-- INSERT INTO `categorias` (`id`, `titulo`, `descricao`, `parent_id`, `site_id`, `lft`, `rght`) VALUES(8, 'Pedagogico Cursos', 'Projetos Pedagógicos', NULL, 1, 15, 16);
...
-- INSERT INTO `categorias` (`id`, `titulo`, `descricao`, `parent_id`, `site_id`, `lft`, `rght`) VALUES(13, 'TA Projetos', 'TA Projetos', NULL, 1, 25, 26);
