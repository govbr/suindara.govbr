 ...
 */
	...
	class NoticiaFixture extends CakeTestFixture {
		...
		public $fields = array(
				...
				'resumo' => array('type' => 'text', 'null' => false),
				'texto' => array('type' => 'text', 'null' => false),
				'datahora_prog_pub' => array('type' => 'datetime', 'null' => true),
				'datahora_prog_exp' => array('type' => 'datetime', 'null' => true),
				'datahora_publicacao' => array('type' => 'datetime', 'null' => true),
				'categoria_id' => array('type' => 'integer', 'null' => false),
				'autor' => array('type' => 'text', 'null' => false),
				'status_id' => array('type' => 'integer', 'null' => false),
				'cartola'   => array('type' => 'text', 'null' => false)
		);
		
		public $records = array(
			array('id' 					=> 1, 
				  'resumo' 			    => 'Resumo para teste' , 
				  'texto' 				=> 'Conteudo para teste',
				  'datahora_prog_pub'   => '2013-04-17 00:00:00', 
				  'datahora_prog_exp'	=> '2013-08-20 00:00:00',
				  //'datahora_publicacao' => null,
				  'categoria_id'		=> 1,
				  'autor'				=> 'Pépe',
				  'status_id'			=> Noticia::STATUS_RASCUNHO, 
				  'cartola'				=> 'Cartola'
			),
