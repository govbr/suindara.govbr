    ...
    <body class="dicas"> 
    	<div id="principal">
			...
			<div id="content">
				...
				<p id="breadCrumb">Voc&ecirc; est&aacute; em: <a href="#" title="Voltar &aacute; P&aacute;gina inicial">P&aacute;gina inicial</a> / Dicas de acessibilidade</p>
            	...
            	<div class="dicas-de-acessibilidade">
					<h3><a href="#" title="Expandir / Retrair">Tamanho do texto <span class="controle-evento">Expandir</span></a></h3>
					<div>
						<ul>
					...
					<h3><a href="#" title="Expandir / Retrair">Alto contraste <span class="controle-evento">Expandir</span></a></h3>
					<div>
						<ul>
							<li>Preto</li>
						</ul>
					...
					<h3><a href="#" title="Expandir / Retrair">Teclas de acesso <span class="controle-evento">Expandir</span></a></h3>
					<div>
					...
					<h3><a href="#" title="Expandir / Retrair">Teclas de acesso dispon&iacute;veis <span class="controle-evento">Expandir</span></a></h3>
					<div> 
					...
					<h3><a href="#" title="Expandir / Retrair">Valida&ccedil;&atilde;o <span class="controle-evento">Expandir</span></a></h3>
					<div> 
					...
					<h3><a href="#" title="Expandir / Retrair">Terminologias <span class="controle-evento">Expandir</span></a></h3>
					<div>
						<h4>Ação Afirmativa</h4>
						...
						<h4>Altas Habilidades/Superdotação</h4>
						...
						<h4>Atendimento Educacional Especializado (AEE)</h4>
						...
						<h4>Atendimento Hospitalar ou Domiciliar</h4>
						...
						<h4>Enriquecimento Curricular</h4>
						...
						<h4>Equipe multiprofissional (EM)</h4>
						...
						<h4>Necessidades Educacionais Específicas (NEE)</h4>
						...
						<h4>Pessoa com deficiência ou com mobilidade reduzida</h4>
						...
						<h4>Salas de recursos multifuncional</h4>
						...
						<h4>Transtornos Globais do Desenvolvimento</h4>
