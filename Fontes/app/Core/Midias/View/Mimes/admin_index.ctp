...
<?php if(count($mimes) == 0) { ?>
	<p class="noInfo">Nenhum registro encontrado</p>
<?php } else { ?>
	<table class="row" summary="Tabela de listagem das extensões de arquivos">
		<thead>
			<tr>
			...
			<tr>
				...
				<td class="two_actions">
					<ul>
						...
						<li>
							<?php echo $this->Html->link('Excluir <span class="oculto">extens&atilde;o: '.$mime['Mime']['extensao'].'</span>', array('plugin' => 'midias', 'controller' => 'mimes', 'action' => 'delete', $mime['Mime']['id']), array('class' => 'del', 'escape' => false), 'Você tem certeza que deseja excluir a extens&atilde;o '.$mime['Mime']['extensao'].' ?'); ?>
						</li>
					</ul>
				</td>
			</tr>
