...
<div id="configPaginator" class="row">
	...
	$default = (isset($this->request->query['limit']) && !empty($this->request->query['limit'])) ? $this->request->query['limit'] : '16';
	echo $this->Form->input('limit', array(
		...
		'id' => 'qtd_itens',
		'options' => array(
				16 => '16 itens por p&aacute;gina',
				28 => '28 itens por p&aacute;gina',
				52 => '52 itens por p&aacute;gina',
				76 => '76 itens por p&aacute;gina',
