<?php 
	...
	// tipo_conteudo é parametro da chamada do element
	//$tipo_conteudo = 'curso';
...
<?php 
	// $nomeConteudo = ($tipo_conteudo == 'curso') ? 'not&iacute;cia' : 'p&aacute;gina';
	$countDocsSemDescricao = 0;
?>

<!-- <h2 class="row"><?php echo $acao; ?> de <span><?php echo ucfirst($nomeConteudo); ?></span></h2> -->
<?php echo $this->element('_form', array(), array('plugin' => 'Midias')); ?>

<div class="imagensNoticia">
	<!-- <h3>Arquivos da <span><?php echo ucfirst($nomeConteudo); ?></span></h3> -->

	<?php if( !isset($midias) || count($midias) == 0) { ?>
	<?php //if(true) { ?>
	
	<p class="noInfo">Voc&ecirc; n&atilde;o possu&iacute; arquivos cadastrados para este curso!</p>
