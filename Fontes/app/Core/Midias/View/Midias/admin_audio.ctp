...
$this->Html->addCrumb('Editar Áudio', array('admin' => true, 'tipo_conteudo' => $tipo_conteudo, 'id_conteudo' => $id_conteudo, 'controller' => 'midias' ,'action' => 'audio', 'id_midia' => $this->data['Midia']['id']));
?>

<div class="content form">
	<h2 class="row">Cadastro de <span><?php echo ($tipo_conteudo=='noticia') ? 'Notícias' : 'Páginas'; ?></span></h2>
	
	<h3>Edição de <span>áudio</span></h3>
	<?php echo $this->AudioPlayer->create($this->data); ?>
	
	<hr />

	<h3>Informações sobre o <span>áudio</span></h3>
