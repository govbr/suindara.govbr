    	...
    	<div id="principal">
			...
			<div id="content">			
				...
				<div id="esquerda">
					...
					<?php 
						$projetos = $this->CmsCategorias->getCategoria('Acessibilidade Projetos');
					...
					<a href="/acessibilidade/projetos" class="veja_mais">Conhe&ccedil;a todos os projetos</a>
				</div>	
				...
				<div id="dicas">
					...
					<ul>
					<?php 
						$dicas = $this->CmsCategorias->getCategoria('Acessibilidade Dicas');
				...
				<div id="manuais">
					...
					<ul>
						<?php 
						$manuais = $this->CmsCategorias->getCategoria('Acessibilidade Manuais');
