        ...
        <div class="container cinterno">
          ...
          <div class="row"> 
            <article class="span12">
              <?php
                $this->Html->addCrumb('Publicações');
                echo $this->element('breadcrumb');
              ?>

              <h3>Nossas Publicações</h3>
            </article>
          </div>
          ...
          <div class="row">
            <ul class="thumbnails thumbnails-1 list-services">
              ...
              <?php
                $categoria_cursos = $this->CmsCategorias->getCategoria("publicacoes");
                if($categoria_cursos){
              ...
              ?>
                          <li class="span4">
                            <div class="thumbnail thumbnail-1"> 
                              <section> 
                                <h4><a href="<?php echo $noticia->createPath('publicacoes', 'visualizar'); ?>" class="link-1"><?php echo $noticia->titulo; ?></a></h4>
