<div class="content form">
	<h2 class="row"> <?php echo $titulo_modulo; ?> de <span>Menus</span> </h2>

	<?php
		echo $this->Form->create('Menu', array('class' => 'cadastro') );
		echo $this->Form->input('id', array('type' => 'hidden'));
		echo $this->Form->input('site_id', array('type' => 'hidden'));
	?>
	
	<fieldset>
		<legend class="oculto">Dados do menu</legend>
	...
	?>
	<?php echo $this->Html->link('Cancelar', array('plugin' => 'menus', 'controller' => 'menus', 'action' => 'index'), array('id'=>'cancelar')); ?> 
</div>