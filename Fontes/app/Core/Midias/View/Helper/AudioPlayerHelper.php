...
class AudioPlayerHelper extends AppHelper {
	...
	public function create($data) {
		...
		$audio = $config->changeExt($data['arquivo'], 'mp3');
		$url = $this->Midias->fileUrl($audio, AUDIO, 'mp3');
		...
		echo $this->Html->scriptBlock('
			$(document).ready(function() {
				...
				swfobject.embedSWF("'.$this->Html->url('/midias/swf/mp3-player.swf?v=2').'", "mp3-player", "420", "280", "10.0.0", "'.$this->Html->url('/midias/swf/expressInstall.swf').'", flashvars, params, attributes);
