        ...
        <div class="container cinterno">
          ...
          <div class="row"> 
            <article class="span12">
              ...
              <p class="breadCrumb">Voc&ecirc; est&aacute; em: <a title="Voltar &aacute; P&aacute;gina inicial" href="#">P&aacute;gina inicial</a> / Tecnologia Assistiva</p>
            </article>
          </div>
          ...
          <div class="row">
            ...
            <ul class="thumbnails thumbnails-1 list-services ">
              <?php 
                    $categoria = $this->CmsCategorias->getCategoria('ta_projetos');
          ...
          <div class="row">
            ...
            <ul class="thumbnails thumbnails-1 list-services">
              <?php 
                    $categoria = $this->CmsCategorias->getCategoria('ta_manuais');
                    if($categoria){
          ...
          <div class="row">
            ...
            <ul class="thumbnails thumbnails-1 list-services">
              <?php 
                    $categoria = $this->CmsCategorias->getCategoria('ta_cursos');
          ...
          <div class="row">
            ...
            <ul class="thumbnails thumbnails-1 list-services">
              <?php 
                    $categoria = $this->CmsCategorias->getCategoria('ta_oas');
