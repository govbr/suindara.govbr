...
$opts = array(
	...
	'roots' => array(
		array(
			...
			'path'          => '../../../files/img/img_post_site_cta/', 			// path to files (REQUIRED) 
			
			// URL abaixo sao para fazer a conexao do elfinder.
			// 
			// Primeira URL - Desenvolvimento
			// Segunda URL - Usado para usar no servidor online
			//
			//'URL'         => '/Fontes/app/webroot/files/img/img_post_site_cta/',  
			//'URL'         => 'http://' . $_SERVER['HTTP_HOST'] . '/files/img/img_post_site_cta/', 
