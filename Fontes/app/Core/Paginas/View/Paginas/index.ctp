<table>
    ...
    <tr>
        ...
        <td><?php echo $this->Html->link('Editar', '/admin/paginas/edit/' . $noticia['Noticia']['id']) ?></td>
        <td><?php echo $this->Html->link('Excluir', '/admin/paginas/delete/' . $noticia['Noticia']['id']) ?></td>
    </tr
    </tr>
    <?php endforeach; ?>
</table>