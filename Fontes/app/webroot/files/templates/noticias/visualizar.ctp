            ...
            <article class="span8">
              <div class="inner-1 post-blog">
                ...
                ?>
                    ...
                    <p><?php echo $noticia->htmlTexto(array(), false, false); ?></p>

                    <?php 
                        $arquivos = $noticia->getArquivos();

                          if(count($arquivos) == 1){
                            echo '<p>Arquivo para download</p>';
                            foreach ($arquivos as $file) {
                              echo $file->htmlArquivo(); 
                            }
                          }else{
                              if($arquivos){
                                echo '<p>Arquivos para download</p>';
                                foreach ($arquivos as $file) {
                                  echo "<li>" . $file->htmlArquivo() . "</li>";
                                }
                              }
                          }
