...
<div class="content form">
	<h2 class="row"> <?php echo $titulo_modulo; ?> de <span> Modalidade </span> </h2>

	<?php echo $this->Form->create('Modalidade', array('class' => 'cadastro') ); ?>
	<fieldset>
	...
	<?php
		...
		echo $this->Form->input('parent_id', array('label' => 'Modalidade Pai', 'empty' => 'Selecione', 'class' => 'w40'));
	?>
	...
	<?php
		...
		echo $this->Form->end();
	?>
	<?php echo $this->Html->link('Cancelar', array('plugin' => 'modalidades', 'controller' => 'modalidades', 'action' => 'index'), array('id'=>'cancelar')); ?> 
</div>
