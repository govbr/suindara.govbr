        ...
        <div class="container cinterno">
          ...
          <div class="row"> 
            <article class="span12">
              <?php
                if($categoriaPai){
                  $this->Html->addCrumb($categoriaPai->titulo, $categoriaNome->createPath('manuais'));
                }
                ...
                ?>
                      <li class="span4">
                        <div class="thumbnail thumbnail-1"> 
                          <section> 
                            <h4><a href="<?php echo $noticia->createPath('manuais', 'visualizar'); ?>" class="link-1"><?php echo $noticia->titulo; ?></a></h4>
