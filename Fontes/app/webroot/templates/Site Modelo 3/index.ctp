            ...
            <div class="row">
                <div class="span12"> 
                    ...
                    <div class="block-slogan">
                        ...
                        <div>
                            <p>Este &eacute; o site do Projeto de Acessibilidade Virtual.</p>
                            <p>Aqui voc&ecirc; poder&aacute; conhecer um pouco sobre o nosso projeto e as a&ccedil;&otilde;es que estamos desenvolvendo.</p>
                        </div>
                    </div>
                </div>
            </div>
      ...
      <div id="content" class="content-extra">
        ...
        <div class="row-2">
          <div class="container">
            ...
            <p>Clique aqui e fa&ccedil;a download do site modelo, disponibilizado sobre as licen&ccedil;as GPL</p>
            <a href="<?php echo $this->CmsTemplate->arquivoPath('site_modelo_3_template.zip') ?>" class="btn btn-1">Download do Site Modelo</a>
          </div>
        </div>
