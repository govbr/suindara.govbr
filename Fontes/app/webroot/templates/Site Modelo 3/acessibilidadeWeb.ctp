        ...
        <div class="container cinterno">
          ...
          <div class="row"> 
            <article class="span12">
              <h3>Projeto Acessibilidade Web</h3>
              <p class="breadCrumb">Voc&ecirc; est&aacute; em: <a title="Voltar &aacute; P&aacute;gina inicial" href="#">P&aacute;gina inicial</a> / Acessibilidade Web</p>
            </article>
          </div>
          ...
          <div class="row">
            ...
            <ul class="thumbnails thumbnails-1 list-services ">
                  <?php 
                    $categoria = $this->CmsCategorias->getCategoria('acessibilidade_projetos');
          ...
          <div class="row">
            ...
            <ul class="thumbnails thumbnails-1 list-services">
              ...
              <?php 
                    $categoria = $this->CmsCategorias->getCategoria('acessibilidade_manuais');
                    if($categoria){
          ...
          <div class="row">
            ...
            <ul class="thumbnails thumbnails-1 list-services">
              <?php 
                    $categoria = $this->CmsCategorias->getCategoria('acessibilidade_cursos');
          ...
          <div class="row">
            ...
            <ul class="thumbnails thumbnails-1 list-services">
              <?php 
                    $categoria = $this->CmsCategorias->getCategoria('acessibilidade_oas');
